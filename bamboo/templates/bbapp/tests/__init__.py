...
from bbapp import create_app
from bbapp.models.user import User, UserDetail, ADMIN, USER, ACTIVE, MALE
from bbapp.config import TestConfig
from bbapp.ext import db, assets
