...
from ..utils.cli import prompt, prompt_pass, prompt_bool, prompt_choices
# --------------------
...
class NewApplication(Command):
    """
    Generates a new bamboo application

    :param appname: application name
    :param use_haml: if False, will no longer use Haml templating
    :param use_coffescript: if False, will no longer use Haml templating
    :param use_sass: if False, will no longer use Sass stylesheets
    :param use_debugger: if False, will no longer use Werkzeug debugger.
                         This can be overriden in the command line
                         by passing the **-d** flag.
    :param options: :func:`werkzeug.run_simple` options.
    ...
    help = description = 'Generates a new bamboo application'

    def __init__(self, appname='bamboo-app',
                 use_haml=True, use_coffeescript=True, use_sass=True, 
                 use_debugger=True, **options):

        self.appname = appname
        self.use_haml = use_haml
        self.use_coffeescript = use_coffeescript
        self.use_sass = use_sass
        self.use_debugger = use_debugger
...
class NewModule(Command):
    """
    Generates a new module into you bamboo application
    ...
    help = description = 'Generates a new module into you bamboo application'

    def __init__(self, modname='bamboo_module', 
                 use_haml=True, use_coffeescript=True, use_sass=True, 
                 use_debugger=True, **options):
